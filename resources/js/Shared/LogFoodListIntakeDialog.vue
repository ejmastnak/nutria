...
function open(foodListIntakeRecord) {
  ...
  form.date = foodListIntakeRecord ? getLocalYYYYMMDD(foodListIntakeRecord.date_time_utc) : getCurrentLocalYYYYMMDD()
  form.time = foodListIntakeRecord ? getLocalHHMM(foodListIntakeRecord.date_time_utc) : getCurrentLocalHHmm()
  isOpen.value = true
}
function cancel() {
  form.clearErrors()
