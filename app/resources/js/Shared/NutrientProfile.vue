...
<template>
  <table class="text-sm sm:text-base text-left text-gray-500">
    ...
    <tbody>
      <tr 
        ...
        class="border-b"
      >
        <td scope="row" class="px-5 py-2 text-gray-800">
          {{nutrient.nutrient}}
        </td>
        ...
        <td class="px-4 py-2 text-right" :class="bg(scale(nutrient.pdv))">
